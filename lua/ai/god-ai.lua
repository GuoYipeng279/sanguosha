...
sgs.ai_skill_cardchosen.guixin = function(self, who, flags)
	for i=0, 5 do
		local that = sgs.ai_skill_cardchosen.guixin(self, who, flags)
		if not self:isFriend(who) or that ~= 230 then return that end
	end
end
